    ...
    <footer className="border-t border-black/[0.06] bg-slate-50/60 py-12">
      <div className="container mx-auto max-w-7xl px-4 sm:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex items-center gap-2.5">
          ...
          <span className="font-extrabold tracking-tight text-slate-950">Sudoku King</span>
          <span suppressHydrationWarning className="text-xs text-slate-400 ml-2 tracking-tight">
        ...
        <div className="flex items-center gap-6 text-xs font-medium text-slate-500">
          ...
          <a href="#leaderboard" className="hover:text-slate-950 transition-colors apple-press-subtle">
            Leaderboard
          </a>
          <a href="#features" className="hover:text-slate-950 transition-colors apple-press-subtle">
            Features
          </a>
          <a href="#modes" className="hover:text-slate-950 transition-colors apple-press-subtle">
            Progression Tiers
          </a>
          <a
