        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {featureList.map((feature, i) => {
            ...
            return (
              <Card
                key={i}
                className="group border border-black/[0.06] bg-white hover:border-black/[0.12] transition-all duration-300 shadow-[0_2px_14px_rgba(0,0,0,0.03)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] rounded-3xl apple-press-subtle"
              >
                <CardHeader>
                  ...
                  <CardTitle className="text-lg font-bold text-slate-950 tracking-tight">
                    {feature.title}
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-slate-600 leading-relaxed text-sm font-normal tracking-tight">
                    {feature.description}
                  </CardDescription>
                </CardContent>
              </Card>
