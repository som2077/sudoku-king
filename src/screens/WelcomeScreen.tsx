...
interface WelcomeScreenProps {
  onGetStarted: () => void;
  onQuickPlay?: () => void;
  onRestorePurchases?: () => Promise<{ success: boolean; restored: boolean; error?: string } | void> | void;
}
  ...
  const handleRestorePurchases = async () => {
    ...
    try {
      ...
      if (restored || useGameStore.getState().isPremium) {
        ...
        Alert.alert(
          "👑 Purchases Restored!",
          "Welcome back! Your VIP access has been successfully restored with unlimited hints, infinite chances & 100% ad-free puzzles.",
          [
            {
        ...
        Alert.alert(
          "No Active VIP Found",
          "No prior subscriptions or lifetime VIP purchases were found for this Google Play account.",
          [{ text: "OK" }],
        );
      }
    } catch (err: any) {
      Alert.alert(
        "Restore Failed",
        err?.message ||
          "Failed to restore purchases. Please check your network connection and try again.",
      );
    } finally {
      setRestoring(false);
    }
    ...
    <View style={styles.root}>
      ...
      <SafeAreaView style={styles.safeArea} edges={["top", "bottom"]}>
        ...
        <View style={styles.centerContainer}>
          ...
          <View
            style={[styles.deviceFrame, { maxHeight: SCREEN_HEIGHT * 0.42 }]}
          >
            <LinearGradient
        ...
        <View style={styles.bottomSection}>
          ...
          {/* Restore Purchases / Payment Button */}
          <TouchableOpacity
            ...
            accessibilityLabel={t("welcome.restorePurchase", "Restore Purchases")}
          >
            {restoring ? (
              <View style={styles.restoreRow}>
                <ActivityIndicator size="small" color="#4B5563" />
                <Text style={styles.restoreButtonText}>
                  {t("welcome.restoring", "Checking Purchases...")}
                </Text>
              </View>
            ) : (
              <View style={styles.restoreRow}>
                ...
                <Text style={styles.restoreButtonText}>
                  {t("welcome.restorePurchase", "Restore Purchases")}
                </Text>
              </View>
            )}
          </TouchableOpacity>
